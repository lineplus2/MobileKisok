...
public class GalleryAdapter extends RecyclerView.Adapter<com.example.kw_mk.GalleryAdapter.GalleryViewHolder> {
    ...
    @Override
    public com.example.kw_mk.GalleryAdapter.GalleryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
